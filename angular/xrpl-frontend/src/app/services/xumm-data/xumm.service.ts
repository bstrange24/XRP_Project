...
export class XummService {
  ...
  createPayload(payload: any): Observable<any> {
    const headers = new HttpHeaders({
      'X-API-Key': '93b47736-fd5d-4d16-968f-c1c565c8e54f', // Replace with your Xumm API key
      'X-API-Secret': '3a89cac1-613b-49b5-b125-1d1a8ba3b35b', // Replace with your Xumm API secret
    });
