...
error_messages = {
    ...
    "tecNO_PERMISSION": lambda: raise_exception("tecNO_PERMISSION - You do not have permission to perform this operation."),
    ...
    "tecNO_TARGET": lambda: raise_exception("tecNO_TARGET - The target account does not exist."),
