...
from .nft.nft import MintNft, GetAccountNft, BurnAccountNft, SellAccountNft, BuyNft, CancelNftOffers
...
urlpatterns = [
    ...
    path('ledger/ledger-info/', LedgerInteraction.get_ledger_info, name='get_ledger_info'),

    # Endpoint to get ledger information like version, uptime, and ledger status.
    # Example: http://127.0.0.1:8000/xrpl/get-server-info/
    path('ledger/server-info/', LedgerInteraction.get_server_info, name='get_server_info'),
    ...
    path('ledger/xrp-reserves/', LedgerInteraction.get_xrp_reserves, name='get_xrp_reserves'),
    ...
    path('trustlines/get-lines/', TrustLine.get_account_trust_lines, name='get_account_trust_lines'),
    ...
    path('trustlines/set/', TrustLine.set_trust_line, name='set_trust_line'),
    ...
    path('trustlines/get/', TrustLine.get_trust_line, name='get_trust_line'),

    # Endpoint to remove a trust lines for a wallet address.
    # Example: http://127.0.0.1:8000/xrpl/get-trust-line/?wallet_address=r4ocA7HYdBXuvQPe1Dd7XUncZu8CT1QzkK
    path('trustlines/remove/', TrustLine.remove_trust_line, name='remove_trust_line'),
    ...
    path('nfts/burn/', BurnAccountNft.as_view(), name='burn_account_nft'),

    # Example: http://127.0.0.1:8000/xrpl/nfts/sell/
    path('nfts/sell/', SellAccountNft.as_view(), name='sell_account_nft'),

    # Example: http://127.0.0.1:8000/xrpl/nfts/buy/
    # path('nfts/buy/', BuyAccountNft.as_view(), name='buy_account_nft'),
